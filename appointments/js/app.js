...
async function initializeApp() {
    // Check for existing session - try web folder auth keys first, then fallback
    let token = localStorage.getItem('psd_accessToken') || sessionStorage.getItem('psd_accessToken');
    let user = localStorage.getItem('psd_user') || sessionStorage.getItem('psd_user');
